 ...
 * @since       1.0
 */
public class ForeignWindow extends ForeignContainer implements Accessible {
     ...
     */
    ForeignWindow(GraphicsConfiguration gc) {
        init(gc);
    }
     ...
     * @see java.awt.GraphicsEnvironment#isHeadless
     */
    ForeignWindow() throws HeadlessException {
        GraphicsEnvironment.checkHeadless();
     ...
     * @see #isShowing
     */
    public ForeignWindow(Frame owner) {
     ...
     * @since     1.2
     */
    public ForeignWindow(Window owner) {
        this(owner == null ? (GraphicsConfiguration)null :
            owner.getGraphicsConfiguration());
        ownedInit(owner);
    }
     ...
     * @since     1.3
     */
    public ForeignWindow(Window owner, GraphicsConfiguration gc) {
        this(gc);
        ownedInit(owner);
    }
