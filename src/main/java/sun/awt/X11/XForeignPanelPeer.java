...
public class XForeignPanelPeer extends XForeignCanvasPeer implements PanelPeer {
    ...
    XForeignPanelPeer(XCreateWindowParams params) {
        super(params);
    }

    XForeignPanelPeer(Component target) {
        super(target);
    }
