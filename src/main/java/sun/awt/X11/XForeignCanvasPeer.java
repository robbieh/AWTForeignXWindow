...
class XForeignCanvasPeer extends XForeignComponentPeer implements CanvasPeer {

    private boolean eraseBackgroundDisabled;

    XForeignCanvasPeer() {}

    XForeignCanvasPeer(XCreateWindowParams params) {
        super(params);
    }

    XForeignCanvasPeer(Component target) {
        super(target);
    }
