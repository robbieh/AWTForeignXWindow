...
public class XForeignComponentPeer extends XForeignWindow implements ComponentPeer, DropTargetPeer,
    BackBufferCapsProvider
{
    ...
    XForeignComponentPeer(Component target, long parentWindow, Rectangle bounds) {
     ...
     */
    XForeignComponentPeer(Component target) {
        super(target);
    }
