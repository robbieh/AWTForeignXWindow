...
public class XForeignBaseWindow {
     ...
     */
    XForeignBaseWindow(long parentWindow, Rectangle bounds) {
     ...
     */
    XForeignBaseWindow(Rectangle bounds) {
        this(new XCreateWindowParams(new Object[] {
            BOUNDS, bounds
        }));
    }

    public XForeignBaseWindow (XCreateWindowParams params) {
        init(params);
    }
    ...
    XForeignBaseWindow(long parentWindow) {
        this(new XCreateWindowParams(new Object[] {
            PARENT_WINDOW, Long.valueOf(parentWindow),
